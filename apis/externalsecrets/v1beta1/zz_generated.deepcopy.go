...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExternalSecretStatusSources) DeepCopyInto(out *ExternalSecretStatusSources) {
	*out = *in
	if in.SecretStores != nil {
		in, out := &in.SecretStores, &out.SecretStores
		*out = make([]ProviderSourceInfo, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ClusterSecretStores != nil {
		in, out := &in.ClusterSecretStores, &out.ClusterSecretStores
		*out = make([]ProviderSourceInfo, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExternalSecretStatusSources.
func (in *ExternalSecretStatusSources) DeepCopy() *ExternalSecretStatusSources {
	if in == nil {
		return nil
	}
	out := new(ExternalSecretStatusSources)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExternalSecretStatusTriggers) DeepCopyInto(out *ExternalSecretStatusTriggers) {
	*out = *in
	if in.InClusterSecrets != nil {
		in, out := &in.InClusterSecrets, &out.InClusterSecrets
		*out = make([]TriggerInClusterSecret, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExternalSecretStatusTriggers.
func (in *ExternalSecretStatusTriggers) DeepCopy() *ExternalSecretStatusTriggers {
	if in == nil {
		return nil
	}
	out := new(ExternalSecretStatusTriggers)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProviderSourceInfo) DeepCopyInto(out *ProviderSourceInfo) {
	*out = *in
	if in.ListedKeys != nil {
		in, out := &in.ListedKeys, &out.ListedKeys
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.FoundKeys != nil {
		in, out := &in.FoundKeys, &out.FoundKeys
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProviderSourceInfo.
func (in *ProviderSourceInfo) DeepCopy() *ProviderSourceInfo {
	if in == nil {
		return nil
	}
	out := new(ProviderSourceInfo)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TriggerInClusterSecret) DeepCopyInto(out *TriggerInClusterSecret) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TriggerInClusterSecret.
func (in *TriggerInClusterSecret) DeepCopy() *TriggerInClusterSecret {
	if in == nil {
		return nil
	}
	out := new(TriggerInClusterSecret)
	in.DeepCopyInto(out)
	return out
}
